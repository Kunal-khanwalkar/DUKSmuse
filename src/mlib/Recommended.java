...
public class Recommended extends javax.swing.JFrame {
    ...
    public Recommended() {
        ...
        {            
            ...
            //String query1 = "select user_id from temp_id";
            ...
            //mystmt.setInt(1,usid);
            //mystmt.execute();
            String query2 = "select song_name, artist_name, album_name, year from recommendation natural join song natural join album natural join artist";
            Statement st=con.createStatement();
        ...
        //Execute procedure and add to table.
    }
    ...
    public ArrayList<Song> songList()
    {
        ...
        try{
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/dbsproject?zeroDateTimeBehavior=convertToNull","root","admin");
